        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 offset-3">
                    ...
                    <div class="form-group  ">
                        <label class="font-weight-bold" for="id_sinta">ID Sinta</label>
                        <input type="text" name="id_sinta" value="<?= $row->id_sinta;  ?>" class="form-control form-control-md" id="id_sinta" placeholder="Masukkan ID Sinta">
                    </div>
                    <div class="form-group  ">
                        <label class="font-weight-bold" for="nama">Username </label>
                        <input type="text" name="username" value="<?= $row->username;  ?>" class="form-control form-control-md" id="username" placeholder="Masukkan Username" readonly>
                    </div>
                    <div class="form-group">
