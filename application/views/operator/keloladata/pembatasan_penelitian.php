<div class="container-fluid">
    <div class="card shadow mb-3">
        ...
        <div class="card-body">
            ...
            <?= form_open_multipart('operator/proses_pembatasan_penelitian'); ?>
            ...
            <?php if (empty($row)) { ?>
                <button type="submit" name="pembatasan_penelitian" class="btn btn-sm btn-primary mt-2">Simpan</button>
            <?php } else { ?>
            ...
            <?php } else { ?>
                <a type="button" href="<?= site_url('operator/reset_pembatasan_penelitian/' . $row->id_pembatasan) ?>" onclick="return confirm('Apakah anda yakin untuk reset pembatasan ini?')" class="btn btn-sm btn-success mt-2">Reset Pembatasan</a>
            <?php } ?>
            ...
            <?php } else { ?>
                <div class="alert alert-primary mt-2" role="alert">
                    Pembatasan penelitian sedang berjalan pada tanggal <?= $row->tanggal_mulai ?> sampai tanggal <?= $row->tanggal_selesai ?>
                </div>
            <?php } ?>
