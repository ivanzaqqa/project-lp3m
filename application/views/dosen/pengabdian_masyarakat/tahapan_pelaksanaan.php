<div class="container">
    ...
    <h2 class="text-center font-weight-bold"><?= $row->judul_pengabmas; ?></h2>
        ...
        <div class="col-sm-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <?= form_open_multipart('dosen/proses_log_book_pengabmas/' . $row->id_pengabmas); ?>
                    ...
                    <table class="table table-responsive border-0">
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="hidden" name="id_pengabmas" id="id_pengabmas" value="<?= $row->id_pengabmas ?>">
        ...
        <div class="col-sm-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <?= form_open_multipart('dosen/proses_tahapan_pelaksanaan_pengabmas/' . $row->id_pengabmas); ?>
                    <table class="table table-responsive border-0">
                        <tr>
