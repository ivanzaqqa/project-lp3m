                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($arsip->file_berita_acara != null) { ?>
                                    <button class="btn btn-sm btn-warning"><a style="color: white;" href="<?php echo base_url() . '/upload/insentif_publikasi/file_berita_acara_special_scopus/' . $arsip->file_berita_acara; ?>">Download</a></button>
                                <?php } else { ?>
